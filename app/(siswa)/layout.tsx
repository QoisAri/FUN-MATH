  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <motion.header
        ...
        className="sticky top-0 z-40 flex items-center justify-center px-4 py-3 bg-card/80 backdrop-blur-md border-b border-border">

        {/* Tengah: logo kecil */}
        <span className="text-lg font-extrabold bg-linear-to-r from-blue-500 to-violet-500 bg-clip-text text-transparent absolute left-1/2 transform -translate-x-1/2">
          FUN-MATH
        </span>
